...
def process_job(job: dict) -> None:
    ...
    try:
        ...
        # O PNG guardado é o mapa de zonagem limpo (sem sobreposições).
        # O georeferenciamento (.pgw) e o CSV de prescrição são gerados pelo
        # endpoint de download (prescription_download_png.php).
        post_result(job, zip_b64, png_b64=png)
