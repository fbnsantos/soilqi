...
<head>
    ...
    <meta name="keywords" content="precision agriculture, agricultura de precisão, soil quality, IoT, robótica agrícola, Universidade do Porto, ORIOOS, ViField, VineShieldDT, QGIS, VRT">
    <meta name="author" content="Universidade do Porto — Agricultura de Precisão">
    <meta name="robots" content="index, follow">
    <link rel="canonical" href="https://soilqi.com/login.php<?= $canonicalLang ?>">
    <link rel="alternate" hreflang="pt" href="https://soilqi.com/login.php?lang=pt">
    <link rel="alternate" hreflang="en" href="https://soilqi.com/login.php?lang=en">
    <link rel="alternate" hreflang="x-default" href="https://soilqi.com/login.php">

    <!-- Open Graph -->
    <meta property="og:type"        content="website">
    <meta property="og:url"         content="https://soilqi.com/login.php<?= $canonicalLang ?>">
